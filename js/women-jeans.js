window.onload=function(){
    ...
    document.getElementById("range3").addEventListener("click",priceRande3);
       ...
       document.getElementById("search-text").addEventListener("keydown",searchWomenJeans);
   ...
   function filterStyle(styleId){
       $.ajax({
           url:"data/womenJeans.json",
           method: "GET",
           dataType: "json",
           success: function(data){
               data= data.filter(s=> s.style.id == styleId);
               printWomenJeans(data);
           },
           error: function(err){
               console.log(err);
           }
   ...
   function printWomenJeans(data){
       ...
       document.getElementById("jeansWomen").innerHTML= print;
   ...
   function searchWomenJeans(){
       ...
       $.ajax({
           ...
           success: function(data){
               ...
               printWomenJeans(filterProducts);
           },
           error: function(err){
               console.log(err);
           }
