window.onload= function(){
    ...
    document.getElementById("search-text").addEventListener("keydown",searchMenShorts);
...
function printMenShorts(data){
    ...
    document.getElementById("shortsMen").innerHTML= print;
