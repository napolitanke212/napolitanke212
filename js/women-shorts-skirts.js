window.onload=function(){
    ...
    document.getElementById("range3").addEventListener("click",priceRande3);
       ...
       document.getElementById("search-text").addEventListener("keydown",searchWomenShortsSkirts);
   ...
   function filterStyle(styleId){
       $.ajax({
           url:"data/womenShortsSkirts.json",
           method: "GET",
           dataType: "json",
           success: function(data){
               data= data.filter(s=> s.style.id == styleId);
               printWomenShortsSkirts(data);
           },
           error: function(err){
               console.log(err);
           }
   ...
   function printWomenShortsSkirts(data){
       let print = "";
       data.forEach(function(e){
           print += `
       ...
       document.getElementById("shortsSkirtsWomen").innerHTML= print;
       bindCartEvents();
   }
   ...
   function searchWomenShortsSkirts(){
       ...
       $.ajax({
           ...
           success: function(data){
               ...
               printWomenShortsSkirts(filterProducts);
           },
           error: function(err){
               console.log(err);
           }
    ...
    $.ajax({
        ...
        success: function(data){
          const filterPrice = data.filter( e=> {
            ...
            printWomenShortsSkirts(filterPrice);
        },
        error: function(err){
            console.log(err);
        }
