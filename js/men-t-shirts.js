window.onload=function(){
   ...
   function filterStyle(styleId){
       $.ajax({
           url:"data/menTShirts.json",
           method: "GET",
           dataType: "json",
           success: function(data){
               data= data.filter(s=> s.style.id == styleId);
               printMenTShirts(data);
           },
           error: function(err){
               console.log(err);
           }
   ...
   function printMenTShirts(data){
       ...
       document.getElementById("tShirtsMen").innerHTML= print;
       bindCartEvents();
   }
   ...
   function searchMenJeans(){
       ...
       $.ajax({
           ...
           success: function(data){
               ...
               printMenTShirts(filterProducts);
           },
           error: function(err){
               console.log(err);
           }
