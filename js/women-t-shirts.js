window.onload=function(){
    ...
    document.getElementById("range3").addEventListener("click",priceRande3);
       ...
       document.getElementById("search-text").addEventListener("keydown",searchWomenTShirts);
   ...
   function filterStyle(styleId){
       $.ajax({
           url:"data/womenTShirts.json",
           method: "GET",
           dataType: "json",
           success: function(data){
               data= data.filter(s=> s.style.id == styleId);
               printWomenTShirts(data);
           },
           error: function(err){
               console.log(err);
           }
   ...
   function printWomenTShirts(data){
       let print = "";
       data.forEach(function(e){
           print += `
       ...
       document.getElementById("tShirtsWomen").innerHTML= print;
       bindCartEvents()
   }
   ...
   function searchWomenTShirts(){
       ...
       $.ajax({
           ...
           success: function(data){
               ...
               printWomenTShirts(filterProducts);
           },
           error: function(err){
               console.log(err);
           }
