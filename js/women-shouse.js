window.onload=function(){
    ...
    document.getElementById("range3").addEventListener("click",priceRande3);
       ...
       document.getElementById("search-text").addEventListener("keydown",searchWomenShouse);
   ...
   function filterStyle(styleId){
       $.ajax({
           url:"data/womenShouse.json",
           method: "GET",
           dataType: "json",
           success: function(data){
               data= data.filter(s=> s.style.id == styleId);
               printWomenShouse(data);
           },
           error: function(err){
               console.log(err);
           }
   ...
   function printWomenShouse(data){
       let print = "";
       data.forEach(function(e){
           print += `
       ...
       document.getElementById("shouseWomen").innerHTML= print;
       bindCartEvents();
   }
   ...
   function searchWomenShouse(){
       ...
       $.ajax({
           ...
           success: function(data){
               ...
               printWomenShouse(filterProducts);
           },
           error: function(err){
               console.log(err);
           }
